...
class TestAcceptFriendship(BaseTest):
    router = "/friendship/accept"

    def test_accept_friendship_success(self, session, client, common_user_authenticated, common_user, another_user):
    ...
    def test_accept_friendship_with_nonexistent_friendship_id(self, session, client, common_user_authenticated):
