...
class TestLogin(BaseTest):
    def test_login_success(self, client, common_user, session):
        # common user password is 'senha_do_usuario123'
        user_password = "senha_do_usuario123"

        # Usando client.post diretamente já que o método precisa de data= e não json=
    ...
    def test_login_with_user_does_not_exist(self, client):
        response = client.post(
            "/auth/login", 
            data={
    ...
    def test_login_with_incorrect_nickname(self, client, common_user):
        # common user password is 'senha_do_usuario123'
        user_password = "senha_do_usuario123"
    ...
    def test_login_with_incorrect_password(self, client, common_user):
        # common user password is 'senha_do_usuario123'
